...
public class ReleaseService {
    ...
    private ReleaseDTO convertToDTO(Release release) {
        return  new ReleaseDTO(release.getId(), release.getVersion(), release.getDescription(), release.getCreatedAt());
    }
    ...
    public ReleaseDTO updateRelease(ReleaseRequestDTO releaseRequestDTO, String id) {
